...
//
// Since the phase ④ tenant switch the BFF authenticates data-plane calls
// with the trusted x-tenant-key the gateway's tenant gate injected into the
// request context — no per-app credentials anywhere in this package.
//
