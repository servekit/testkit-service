...
func New(user userservice.Service, storage storageservice.Service, message messageservice.Service, opts ...Option) *Service {
	s := &Service{user: user, storage: storage, message: message}
